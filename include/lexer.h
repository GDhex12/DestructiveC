...
public:
    Lexer(string name) : sourceName(name)
    {
        ...
        KeywordRegistry["inte"] = token_int;
        KeywordRegistry["~inte"] = token_intDC;
        KeywordRegistry["double"] = token_double;
        KeywordRegistry["charline"] = token_string_type;
        KeywordRegistry["void"] = token_void;
        KeywordRegistry["fun"] = token_fn;
        KeywordRegistry["return"] = token_return;
        KeywordRegistry["assume"] = token_if;
        KeywordRegistry["other"] = token_else;
        KeywordRegistry["loopFor"] = token_for;
        KeywordRegistry["loopWhile"] = token_while;
        KeywordRegistry["define"] = token_define;
        KeywordRegistry["boolean"] = token_boolean;
    ...
    bool isTokenIntDC() { return currentToken == token_intDC; }
